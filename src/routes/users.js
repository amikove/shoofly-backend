...
const {
  ...
  client_validation_hours, client_validation_reminder_hours,
  schedule_conflict_window_hours, transfer_cooldown_hours,
  transfer_cooldown_before_hours,
  abandon_during_mission_cooldown_hours, stale_mission_hours, stale_mission_min_lead_hours,
  pending_mission_expiration_hours,
  ...
  candidature_relance_imminent_threshold_minutes,
  unread_whatsapp_email_fallback_minutes,
